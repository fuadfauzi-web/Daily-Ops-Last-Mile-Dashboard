...
SUMMARIES = {
    ...
    ("get", "/api/recovery/active-missing"): "Recovery -> Active Missing: the open missing tickets in the caller's access (Ship Out and B2B left out) with what stations answered about each.",
