...
const SECTIONS = [
  {
    ...
    body: ({ rank }) => {
      const rows = [
        ...
        { role: "Admin", rank: 3, text: `Everything: full user management, all Settings screens, the Admin page (Documents, KPI Targets, Data Refresh), replying to feedback${F.roleTester ? " and the Role Tester" : ""}.` },
      ...
      <div className="space-y-2 text-sm text-slate-700">
        ...
        <Bullets
          items={[
            ...
            <><strong>KPI Targets</strong>: the target of every KPI (FIFO D0, D0, D3, D7, Prior, Lost, COD RTS, Invalid POD) for each region, in %. Change a number and press Save -- the KPI pages, the Weekly Dashboard, Invalid POD and COD RTS use it straight away. A changed box turns amber and shows the built-in default under it; <em>Back to default</em> puts the default back. Lost is a percentage too (0.005 means 0.005%). Hybrid Productivity targets will be added here once they are set.</>,
