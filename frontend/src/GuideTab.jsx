      ...
      <div className="space-y-2 text-sm text-slate-700">
        ...
        <Bullets
          items={[
            ...
            rank >= 3 ? (
              <><strong>Data upload</strong> (admins only): each page has a Data upload button. Every slot has an <em>Open in Metabase</em> link: click it, download the results as CSV, then choose the file -- CSV or Excel; for a workbook the right sheet is picked for you -- and it is loaded straight away. One current file per slot; uploading again replaces it. For Hybrid Productivity an uploaded file is used instead of Metabase until you remove it.</>
            ) : (
