...
The BUILT-IN snapshot of the "Region List" master sheet (151 Last Mile stations across 5 regions, snapshot 2026-09-26); generated by
...
HUBS: dict[str, tuple[str, str, str, str]] = {
    ...
    'E3-BKW-1-149': ('Batu Kawa', 'Station Batu Kawa', 'East Malaysia 3', 'East Malaysia'),
    'E3-KCH-1-146': ('Kuching', 'Station Kuching', 'East Malaysia 3', 'East Malaysia'),
    'E3-SAM-1-148': ('Samarahan', 'Station Samarahan', 'East Malaysia 3', 'East Malaysia'),
    'E3-PTJ-1-147': ('Petra Jaya', 'Station Petra Jaya', 'East Malaysia 3', 'East Malaysia'),
    'E4-BTU-1-151': ('Bintulu', 'Station Bintulu', 'East Malaysia 4', 'East Malaysia'),
    'E4-MYY-1-150': ('Miri', 'Station Miri', 'East Malaysia 4', 'East Malaysia'),
    'E3-SBW-1-144': ('Sibu', 'Station Sibu', 'East Malaysia 4', 'East Malaysia'),
    'E3-TOK-1-145': ('Saratok', 'Station Saratok', 'East Malaysia 4', 'East Malaysia'),
}
